...
This scraper is driven by a config dataclass. You can use one of the pre-built configs from `scraper.config` or define your own. This allows you to easily add support for a new search engine or fix an existing one if its HTML structure changes.
